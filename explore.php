...
<section class="section">
    ...
    type="text"
    id="ajaxSearch"
    placeholder="Type city, country or property..."
        ...
        <div class="country-card">
            ...
            <div>
                ...
                <p>
                    ...
                    University:
                    <?php
                    echo $property["university_distance"];
                    ?>
                ...
                <a
                href="property.php?id=<?php echo $property["id"]; ?>"
                class="primary-btn">
